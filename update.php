...
<div class="col-5  border border-5 border-dark p-4">
    <h2><?php
    $order=$_GET['OrderID'];
    ...
    <form action="update_form.php" method="post" >
        ...
        <label for="quantity" class="form-label">Select Quantity</label>
            ...
            <select class="form-select" id="quantity" name="quantity" value="<?php echo $row['quantity'];?>">
            ...
            <div class="my-3">
        <input type="submit" value="Update & save" class="btn btn-success">
        </div>
